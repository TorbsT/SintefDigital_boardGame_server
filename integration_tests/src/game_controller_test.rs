...
use game_core::{
    ...
    game_data::{GameState, NewGameInfo, Player},
};
...
mod tests {
    ...
    use game_core::game_data::PlayerInput;

    use game_core::game_data::{Node, PlayerInputType};
    ...
    fn test_player_movement() {
        ...
        let input = PlayerInput {
            ...
            game_id: player.connected_game_id.unwrap(),
        };
